...
- **认证方式**: Bearer Token
- **API Key**: `ckb_dev_a0e0b4f17a583c039b2943be335bee6b52642a8fbc2ebdca07821454f4d42fee`
  ...
  "mcpServers": {
    "cool-blog": {
      "transport": {
        ...
        "url": "https://blog.wenjiaqi.top/api/mcp",
        "headers": {
          "Authorization": "Bearer ckb_dev_a0e0b4f17a583c039b2943be335bee6b52642a8fbc2ebdca07821454f4d42fee"
        }
      }
    }
  }
...
```
Bearer ckb_dev_a0e0b4f17a583c039b2943be335bee6b52642a8fbc2ebdca07821454f4d42fee
```
...
```bash
# 列出工具
curl -H "Authorization: Bearer ckb_dev_a0e0b4f17a583c039b2943be335bee6b52642a8fbc2ebdca07821454f4d42fee" \
  "https://blog.wenjiaqi.top/api/mcp?method=tools/list" | jq '.'

# 列出文章
curl -X POST \
  -H "Authorization: Bearer ckb_dev_a0e0b4f17a583c039b2943be335bee6b52642a8fbc2ebdca07821454f4d42fee" \
